...
class SquadsBottomSheetDialog :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvInsertEvent.text = getString(R.string.add_squads)
